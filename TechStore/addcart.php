...
<div class="top_bg" id="home">
	<div class="container">
		<div class="header_top">
			...
			<div class="top_left">
				<span class="top_right"> <a class="header_top" style ="color:white;" href="feedback.php">Feedback .</style></a> | Call us : +91-99887766558</span>
			</div>
...
<!--order strored in database-->
	<div class="products">
		...
		$sql = "SELECT * FROM products WHERE p_id = $mycart";
			...
			echo '<br><h1><center>Go Back To -> <a href="shoes.php">New Arrival</a> / <a href="tshirt.php">Tools</a> / <a href="watches.php">Retro</a>  /  <a href="cart.php">Go To Cart</a></center></h1>';
			?>
		<!--storing complete-->
</div>
